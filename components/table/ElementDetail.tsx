    ...
    <div className="mt-3 rounded-xl p-4" style={{ background: 'var(--color-bg2)', border: '0.5px solid var(--color-border)' }}>
      ...
      {level === 'l3' && (
        <div className="grid gap-2" style={{ gridTemplateColumns: 'repeat(auto-fill, minmax(150px, 1fr))' }}>
          ...
          <Prop label="Oxidation" value={profile.level3.electronic.oxidationStates.common.join(', ') || 'N/A'} />
      ...
      <div className="mt-3 rounded-lg px-3 py-2 font-mono text-sm" style={{ background: 'var(--color-bg)', border: '0.5px solid var(--color-border)' }}>
